...
exports.getPatches = async (req, res) => {
    try {
        ...
        const itemsNew = fs.readFileSync(path.join(__dirname, '../assets/npc_items_custom3.txt'), 'utf-8');
        ...
        const heroesOld = fs.readFileSync(path.join(__dirname, '../assets/addon_russian.txt'), 'utf-8');
        const heroesNew = fs.readFileSync(path.join(__dirname, '../assets/addon_russian4.txt'), 'utf-8');
